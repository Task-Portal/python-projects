...
class FacebookCrawler:
    ...
    def login(self, login, password):
        ...
        self.driver.find_element("email"'email').send_keys(login)
        self.driver.find_element("pass",'pass').send_keys(password)
        self.driver.find_element("loginbutton",'loginbutton').click()
...
if __name__ == '__main__':
    crawler = FacebookCrawler(login='alex.ru.fm@mail.ru', password='11011955')
